...
def trading_algorithm(session_info):
    ...
    while not is_complete:
        ...
        print(currency_from, currency_to, profit)
        print(session_info['currencyToBalance'][currency_from])
...
print(f"Final JPY Balance: {final_balance}")
final_balance
